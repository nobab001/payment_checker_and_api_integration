  ...
  Widget build(BuildContext context) {
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              ...
              'অন্য কীওয়ার্ড দিয়ে খুঁজুন (প্রথমে লোকাল, তারপর অনলাইন)',
    ...
    if (!deviceConfigured) {
      ...
      hint =
          ...
          'Device Settings-এ SIM, মোবাইল নম্বর ও Admin Template সেভ করুন, তারপর Start Service চালু করুন।';

    } else if (!monitoringEnabled) {

      hint = 'Start Service চালু করুন। নতুন পেমেন্ট SMS আসলে এখানে দেখা যাবে।';

    } else {

      hint =

          'ইনবক্স স্ক্যান করা হয় না — শুধু নতুন ইনকামিং SMS (ব্যাকগ্রাউন্ড) এখানে যোগ হবে।';
...
class SmsHistoryListTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final trx = (record.trxId != null && record.trxId!.isNotEmpty)

        ? record.trxId!

        : (SmsParser.extractTransactionId(record.m) ?? '—');
